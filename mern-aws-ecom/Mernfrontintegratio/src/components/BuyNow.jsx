...
export default function BuyNow() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 flex items-center justify-center p-8">
      <div className="bg-white rounded-2xl shadow-2xl p-10 md:p-14 max-w-2xl w-full space-y-10">
        <div className="text-center">
          <h2 className="text-4xl font-bold text-green-800 mb-4">Buy Now</h2>
          <div className="w-24 h-1 bg-green-500 mx-auto rounded-full"></div>
        </div>
        
        <div className="p-6 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200 space-y-4">
